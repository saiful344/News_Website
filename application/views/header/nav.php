  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar ipul" href="index.html">
            <img src="<?= base_url();?>assets/images/logo_2.png" alt="logo" height="200"/>
        </a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?= site_url("News");?>">Manage</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?= site_url("News/kategori");?>">Kategori</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url("Pengumuman");?>">
              <i class="menu-icon far fa-bell"></i>
              <span class="menu-title">Pengumuman</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url("Coment/coment")?>">
